namespace O2DESNet.Drawing
{
    ...
    public struct Margin
    {
        ...
        public Margin(double x, double y)
        {
            _x = x;
            _y = y;
        }
        ...
        /// </returns>
        public static Margin operator +(Margin dim1, Margin dim2)
        {
        ...
        private static Margin Add(Margin margin1, Margin margin2)
        {
            return new Margin(margin1.X + margin2.X, margin1.Y + margin2.Y);
        }

        private static Margin Subtract(Margin margin1, Margin margin2)
        {
            return new Margin(margin1.X - margin2.X, margin1.Y - margin2.Y);
        }
        ...
        public static Margin Round(Margin value)
        {
            return new Margin((int)Math.Round(value.X), (int)Math.Round(value.Y));
        }
