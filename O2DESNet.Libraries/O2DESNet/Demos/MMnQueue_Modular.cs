...
{
    public class MMnQueue_Modular : SandboxBase, IMMnQueue
    {
            ...
            : base(seed)
        {
            ...
            Generator.OnArrive += () => Queue.RequestEnqueue(new Load());
            Generator.OnArrive += Arrive;

            Queue.OnEnqueued += Server.RequestStart;
