...
namespace O2DESNet
{
    public class Event : IDisposable
    {
        ...
        internal SandboxBase Owner { get; }
        internal FutureEventList FutureEventList { get; private set; }
        internal DateTime ScheduledTime { get; private set; }        
        internal Action Action { get; private set; }

        internal Event(SandboxBase owner, Action action, DateTime scheduledTime, string tag = null)
        {
            Owner = owner;
            FutureEventList = owner.FutureEventList;
            Action = action;
