...
namespace OfficeOpenXml
{
    ...
    public class ExcelRangeBase : ExcelAddress, IExcelCell, IDisposable, IEnumerable<ExcelRangeBase>, IEnumerator<ExcelRangeBase>
    {
        ...
        public void AutoFitColumns(double MinimumWidth, double MaximumWidth)
        {
            ...
            var nfont = SystemFonts.CreateFont(nf.Name, 10, fs);
            ...
            foreach (var cell in this)
            {
                ...
                else
                {
                    ...
                    f = SystemFonts.CreateFont(fnt.Name, fnt.Size, fs);
                ...
                var size = TextMeasurer.Measure(t, new RendererOptions(f));
                //var size = graphics.MeasureString(t, f, 10000, StringFormat.GenericDefault);
